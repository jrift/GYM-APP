  ...
  return (
    ...
    <section class="section workout-plans" id="workouts">
        ...
        <div class="plan">
            ...
            <p>Take your workouts to the next level with our intermediate plan.</p>
        </div>
        <div class="plan">
            <h3>Advanced Plan</h3>
            <p>Challenge yourself with our advanced workouts designed for experts.</p>
        </div>
    </section>
    ...
    <footer>
        ...
        <p>Follow us on <a href="https://twitter.com/ssmgym" target="_blank">Twitter</a>, <a href="https://facebook.com/ssmgym" target="_blank">Facebook</a>, and <a href="https://instagram.com/ssmgym" target="_blank">Instagram</a>.</p>
    </footer>
